...
anno_path_dict = {'argweave': 'argweave_snpsnap_eur_ld0.1_collection.pickle',
                'betascore': 'betascore_snpsnap_eur_ld0.1_collection.pickle',
                'fst_eas_afr': 'fst_eas_afr_snpsnap_eur_ld0.1_collection.pickle',
                'fst_eur_afr': 'fst_eur_afr_snpsnap_eur_ld0.1_collection.pickle',
                'fst_eur_eas': 'fst_eur_eas_snpsnap_eur_ld0.1_collection.pickle',
                'gerp': 'gerp_snpsnap_eur_ld0.1_collection.pickle',
                'iES_Sabeti': 'iES_Sabeti_snpsnap_eur_ld0.1_collection.pickle',
                'linsigh': 'linsigh_snpsnap_eur_ld0.1_collection.pickle',
                'phastCon100': 'phastCon100_snpsnap_eur_ld0.1_collection.pickle',
                'phyloP100': 'phyloP100_snpsnap_eur_ld0.1_collection.pickle',
                'xpehh_afr2_eas': 'xpehh_afr2_eas_snpsnap_eur_ld0.1_collection.pickle',
                'xpehh_afr2_eur': 'xpehh_afr2_eur_snpsnap_eur_ld0.1_collection.pickle',
                'xpehh_eas_eur': 'xpehh_eas_eur_snpsnap_eur_ld0.1_collection.pickle'}

###
###    inputs and outputs
###

inputfile="/dors/capra_lab/users/abraha1/prelim_studies/2020_02_clapbeat/data/gwas_selection/raw_clapbeat23_sumstats_for_gwas_selection.tsv" # gwas file
outputdir=f"/dors/capra_lab/users/abraha1/prelim_studies/2020_02_clapbeat/data/gwas_selection/{analysis_name}_gwas_selection"
